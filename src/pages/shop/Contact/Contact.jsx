	...
	const onFinish = async (values) => {
		try {
			const response = await axios.post(
				"http://localhost:8099/api/contacts",
				values
			);
	...
	return (
		<div className="contact-container">
			<div className="contact-info">
				...
				<p>
					<EnvironmentOutlined /> Địa chỉ: số 508, Long Bình, Quận 9,
					TP. Hồ Chí Minh
				</p>
				<p>
					<PhoneOutlined /> Số điện thoại: 0888115511
				</p>
				<p>
					<MailOutlined /> Email: sales@flonestore.com
				</p>
				<Divider />
